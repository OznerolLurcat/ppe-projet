...
import static Final.Logiciel.creationDuCV1;
import com.karimandco.auth.ChampSecret;
 ...
 * @author f.bruckmann
 */
public class JPanelConnexionNum extends javax.swing.JPanel {

    private ArrayList<JButton> tableau = new ArrayList<JButton>();
    public static Integer idUtilisateur;
    public static String idUtilisater;
    public static Blob photo;
    
public Logiciel lienVersUnObjetLogicielQuiContientMoi=null;
...
//    }
    ...
    private void initComponents() {
        ...
        panneauIdentifiant.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusLost(java.awt.event.FocusEvent evt) {
                panneauIdentifiantFocusLost(evt);
            }
        });

        jButton26.setText("Supprimer caractère");
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addContainerGap()
                                .addComponent(jButtonConfirmerConnexion, javax.swing.GroupLayout.PREFERRED_SIZE, 225, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(jButton26, javax.swing.GroupLayout.PREFERRED_SIZE, 233, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void jButton26MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton26MouseClicked
        ...
        String mdp = String.valueOf(panneauMdp.getChampSecret1().getPassword());
        if (mdp.length() <= 0) {
            jLabelEtatConnexion.setText("Champ mot de passe vide");
        } else {
            mdp = mdp.substring(0, mdp.length() - 1);
            panneauMdp.getChampSecret1().setText(mdp);
    ...
    private void jButtonConfirmerConnexionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonConfirmerConnexionActionPerformed
        if (panneauIdentifiant.getChamp2().verifIdentifiant() && panneauMdp.getChampSecret1().verifPassword()) {
            ...
            JPanelConnexionNum.idUtilisater = this.panneauIdentifiant.getChamp2().getText();
            ResultSet resultat = connexion.requeteSelection("SELECT id FROM utilisateurs WHERE identifiant='" + JPanelConnexionNum.idUtilisater + "' AND mot_de_passe='" + mdpCrypter + "'");
            ResultSet resultatphoto = connexion.requeteSelection("SELECT photo FROM utilisateurs WHERE identifiant='" + JPanelConnexionNum.idUtilisater + "' AND mot_de_passe='" + mdpCrypter + "'");
            try {
                if (resultat.next()) {
                    String identifiant = this.panneauIdentifiant.getChamp2().getText();

                    jLabelEtatConnexion.setForeground(Color.blue);
                    jLabelEtatConnexion.setText("Connexion réussie");
                    //jLabelEtatConnexion.setText(id);
                    creationDuCV1.setIdUtilisateur(com.karimandco.mdp.JPanelConnexionNum.idUtilisateur);
                    

                     Integer id=JPanelConnexionNum.idUtilisateur;
                     System.out.println(id+"               99455187815156986465321465465497846515321465469784681532116546588946846532133219999999999999999999999999999999999999999999999999");
            System.out.println(id);
            if (resultatphoto.next()) {
            JPanelConnexionNum.photo = resultatphoto.getBlob("photo");        
            }
            if (id != com.karimandco.mdp.JPanelConnexionNum.idUtilisateur){

                this.lienVersUnObjetLogicielQuiContientMoi.setjTabbedPane1(2,false);
                 this.lienVersUnObjetLogicielQuiContientMoi.setjTabbedPane1(3,false);
                this.lienVersUnObjetLogicielQuiContientMoi.setjTabbedPane1(4,false);
                this.lienVersUnObjetLogicielQuiContientMoi.setjTabbedPane1(5,false);
                this.lienVersUnObjetLogicielQuiContientMoi.setjTabbedPane1(6,false);
            System.out.println("if");
            creationDuCV1.setIdUtilisateur(com.karimandco.mdp.JPanelConnexionNum.idUtilisateur);
            
        }else if (id == 64){

            this.lienVersUnObjetLogicielQuiContientMoi.setjTabbedPane1(1,false);
            this.lienVersUnObjetLogicielQuiContientMoi.setjTabbedPane1(2,true);
            this.lienVersUnObjetLogicielQuiContientMoi.setjTabbedPane1(3,true);
            this.lienVersUnObjetLogicielQuiContientMoi.setjTabbedPane1(4,true);
            this.lienVersUnObjetLogicielQuiContientMoi.setjTabbedPane1(5,true);
            this.lienVersUnObjetLogicielQuiContientMoi.setjTabbedPane1(6,true);
            ...
            jLabelEtatConnexion.setText("Remplir les champs");
        }


    }//GEN-LAST:event_jButtonConfirmerConnexionActionPerformed

    private void panneauIdentifiantFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_panneauIdentifiantFocusLost
        // TODO add your handling code here:
    }//GEN-LAST:event_panneauIdentifiantFocusLost
    ...
    public javax.swing.JButton jButtonConfirmerConnexion;
