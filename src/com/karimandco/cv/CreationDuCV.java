...
public class CreationDuCV extends javax.swing.JPanel {
    ...
    public Integer idUtilisateur = com.karimandco.mdp.JPanelConnexionNum.idUtilisateur;
    ...
    public CreationDuCV(Integer idCV, Integer idUtilisateur) {
        initComponents();
        this.idUtilisateur = com.karimandco.mdp.JPanelConnexionNum.idUtilisateur;
        this.idCV = idCV;
...
public void chargerCV() throws SQLException {
        ...
        com.karimandco.bdd.DaoSIO connexion = com.karimandco.bdd.DaoSIO.getInstance();
                ...
                System.out.println(com.karimandco.mdp.JPanelConnexionNum.idUtilisateur+"      _   tetstsd");
        List<Map<String, Object>> utilisateur = getUtilisateur(com.karimandco.mdp.JPanelConnexionNum.idUtilisateur), cv = getCV(this.idCV, com.karimandco.mdp.JPanelConnexionNum.idUtilisateur), formation = getFormation(com.karimandco.mdp.JPanelConnexionNum.idUtilisateur), experiencePro = getExperiencePro(com.karimandco.mdp.JPanelConnexionNum.idUtilisateur);
        idTabExperiencePro = 1;
        idTabFormation = 1;
        System.out.println(utilisateur+"AAAAAAAAAAAAAAAAAAAA");
        if(utilisateur != null){
                    System.out.println("different de nul");
            if (cv != null && cv.size() > 0) {
                System.out.println("cv different de nul");
...
//            this.setVisible(false);
    ...
    public JLabel getjLabelEtatUtilisateur() {
        return jLabelEtatUtilisateur;
    }
